...
namespace ANTLR_Test.Classes
{
    class ExcelInteropImporter : SpreadSheetImporter
    {
        ...
        public override void ImportFile(string path, string output)
        {
            ...
            try
            {
                Workbook workBook = app.Workbooks.Open(Path.GetFullPath(path), Type.Missing, true, Type.Missing, Type.Missing, Type.Missing, true, Type.Missing, Type.Missing, false, false, Type.Missing, false, Type.Missing, false);
